...
T08 adds the deterministic text-free Source Graph, provenance-address records,
resolver policies/results, and projection-lineage descriptor through the same
compatibility-by-addition rule; it does not expose fixture decoders or indexes.
"""
...
from cognityx_ingest.source_graph import (
    ...
    SOURCE_GRAPH_SCHEMA,
    AddressResolution,
    AllowAllProvenanceAccess,
    EvidenceSetAddress,
    GraphProjectionDescriptor,
    LogicalProvenanceAddress,
    ProvenanceAccessPolicy,
    ProvenanceAddressCatalog,
    ProvenanceAddressError,
    ProvenanceAddressNotFoundError,
    ProvenanceAddressResolver,
    ProvenanceAddressValidationError,
    ProvenanceResolutionError,
    ProvenanceSelector,
    ProvenanceTarget,
    ProvenanceVersionPolicy,
